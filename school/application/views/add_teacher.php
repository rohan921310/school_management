<section role="main" class="content-body pb-none">
    ...
    <section class="panel">
      ...
      <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" placeholder="Enter Class" class="form-control" id="inputDefault" <?php echo set_value('teacher'); ?> name="teacher">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" placeholder="Enter Class" class="form-control" id="inputDefault" <?php echo set_value('email'); ?> name="email">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" placeholder="Enter Class" class="form-control" id="inputDefault" <?php echo set_value('mobile'); ?> name="mobile">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" placeholder="Enter Class" class="form-control" id="inputDefault" <?php echo set_value('address'); ?> name="address">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" placeholder="Enter Class" class="form-control" id="inputDefault" <?php echo set_value('username'); ?> name="username">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" placeholder="Enter Class" class="form-control" id="inputDefault" <?php echo set_value('password'); ?> name="password">

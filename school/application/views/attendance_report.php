<section role="main" class="content-body pb-none">
    ...
    <form class="form-horizontal form-bordered" method="post" action="<?php echo base_url(); ?>index.php/view_attendance">
        ...
        <div class="col-md-6 center">
            ...
            <div class="panel-body" style="margin: 2px 106px; background: #ecedf0;">
                <button type="submit" class="mb-xs mt-xs mr-xs btn btn-primary"> View Attendance</button>

<section role="main" class="content-body pb-none">
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Assign Attendance</h2>
        </header>

    </section>
    <form class="form-horizontal form-bordered" method="post" action="<?php echo base_url(); ?>index.php/add_assign_attendance">

<section role="main" class="content-body pb-none">
    ...
    <section class="panel">
      ...
      <form class="form-horizontal form-bordered" method="post" action="<?php echo base_url(); ?>index.php/add_class">
      <div class="form-group">
            <label class="col-md-2 control-label" for="inputDefault">Class *</label>
            <div class="col-md-6">
                <input type="text" placeholder="Enter Class" class="form-control" id="inputDefault" <?php echo set_value('class'); ?> name="class">

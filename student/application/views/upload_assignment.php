...
<div class="col-md-12  " >
                        <div class="card text-white bg-warning">
                            ...
                            <div class="card-body " style="text-align: center;">
                                ...
                                <p class="card-text"> <h3>Select Teacher  </h3> </p>
                        ...
                        <div class="row" style="text-align: center;">
                            <?php if (!empty($fetch_teacher)) {
                                foreach ($fetch_teacher as $ft) { ?>
                                   ...
                                   <form class="form" method="post" action="<?= base_url() ?>index.php/select_subject">
                                    
                                    <div class="card text-white bg-danger" style="text-align: center;">
                                        <input type="hidden" value="<?php echo $ft['teacher_id'] ?>" name="teacher_id">
